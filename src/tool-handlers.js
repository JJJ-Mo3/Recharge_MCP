...
export class RechargeToolHandlers {
  ...
  async handleUpdateCustomer(args) {
    try {
      const client = this.createClient(args);
      const { customer_id, api_key, ...customerData } = args;
  ...
  async handleGetCustomerAddresses(args) {
    try {
      const client = this.createClient(args);
      const { customer_id, api_key, ...params } = args;
  ...
  async handleCreateCustomerPaymentSource(args) {
    try {
      const client = this.createClient(args);
      const { customer_id, api_key, ...paymentSourceData } = args;
  ...
  async handleUpdateCustomerPaymentSource(args) {
    try {
      const client = this.createClient(args);
      const { customer_id, payment_source_id, api_key, ...paymentSourceData } = args;
  ...
  async handleUpdateSubscription(args) {
    try {
      const client = this.createClient(args);
      const { subscription_id, api_key, ...subscriptionData } = args;
  ...
  async handleSetNextChargeDate(args) {
    try {
      const client = this.createClient(args);
      const { subscription_id, date, api_key } = args;
      const data = await client.setNextChargeDate(subscription_id, { date });
      return this.formatResponse(data);
    } catch (error) {
      return this.handleError(error);
    }
  ...
  async handleGetSubscriptionCharges(args) {
    try {
      const client = this.createClient(args);
      const { subscription_id, api_key, ...params } = args;
  ...
  async handleUpdateSubscriptionLineItem(args) {
    try {
      const client = this.createClient(args);
      const { subscription_id, line_item_id, api_key, ...lineItemData } = args;
  ...
  async handleUpdateSubscriptionNote(args) {
    try {
      const client = this.createClient(args);
      const { subscription_id, note_id, api_key, ...noteData } = args;
  ...
  async handleUpdateSubscriptionDeliverySchedule(args) {
    try {
      const client = this.createClient(args);
      const { subscription_id, delivery_schedule, api_key } = args;
      const data = await client.updateSubscriptionDeliverySchedule(subscription_id, delivery_schedule);
      return this.formatResponse(data);
    } catch (error) {
      return this.handleError(error);
    }
  ...
  async handleApplySubscriptionDiscount(args) {
    try {
      const client = this.createClient(args);
      const { subscription_id, discount_id, api_key } = args;
      const data = await client.applySubscriptionDiscount(subscription_id, { discount_id });
      return this.formatResponse(data);
    } catch (error) {
      return this.handleError(error);
    }
  ...
  async handleUpdateOrder(args) {
    try {
      const client = this.createClient(args);
      const { order_id, api_key, ...orderData } = args;
  ...
  async handleGetOrderLineItems(args) {
    try {
      const client = this.createClient(args);
      const { order_id, api_key, ...params } = args;
  ...
  async handleUpdateCharge(args) {
    try {
      const client = this.createClient(args);
      const { charge_id, api_key, ...chargeData } = args;
  ...
  async handleDelayCharge(args) {
    try {
      const client = this.createClient(args);
      const { charge_id, date, api_key } = args;
      const data = await client.delayCharge(charge_id, { date });
      return this.formatResponse(data);
    } catch (error) {
      return this.handleError(error);
    }
  ...
  async handleGetChargeLineItems(args) {
    try {
      const client = this.createClient(args);
      const { charge_id, api_key, ...params } = args;
  ...
  async handleUpdateChargeLineItem(args) {
    try {
      const client = this.createClient(args);
      const { charge_id, line_item_id, api_key, ...lineItemData } = args;
  ...
  async handleApplyChargeDiscount(args) {
    try {
      const client = this.createClient(args);
      const { charge_id, discount_id, api_key } = args;
      const data = await client.applyChargeDiscount(charge_id, { discount_id });
      return this.formatResponse(data);
    } catch (error) {
      return this.handleError(error);
    }
  ...
  async handleUpdateAddress(args) {
    try {
      const client = this.createClient(args);
      const { address_id, api_key, ...addressData } = args;
  ...
  async handleGetAddressSubscriptions(args) {
    try {
      const client = this.createClient(args);
      const { address_id, api_key, ...params } = args;
  ...
  async handleUpdateDiscount(args) {
    try {
      const client = this.createClient(args);
      const { discount_id, api_key, ...discountData } = args;
  ...
  async handleUpdateMetafield(args) {
    try {
      const client = this.createClient(args);
      const { metafield_id, api_key, ...metafieldData } = args;
  ...
  async handleUpdateWebhook(args) {
    try {
      const client = this.createClient(args);
      const { webhook_id, api_key, ...webhookData } = args;
  ...
  async handleUpdatePaymentMethod(args) {
    try {
      const client = this.createClient(args);
      const { payment_method_id, api_key, ...paymentMethodData } = args;
  ...
  async handleUpdateCheckout(args) {
    try {
      const client = this.createClient(args);
      const { checkout_token, api_key, ...checkoutData } = args;
  ...
  async handleUpdateOnetime(args) {
    try {
      const client = this.createClient(args);
      const { onetime_id, api_key, ...onetimeData } = args;
  ...
  async handleUpdateStoreCredit(args) {
    try {
      const client = this.createClient(args);
      const { store_credit_id, api_key, ...storeCreditData } = args;
  ...
  async handleUpdateCollection(args) {
    try {
      const client = this.createClient(args);
      const { collection_id, api_key, ...collectionData } = args;
  ...
  async handleUpdateBundleSelection(args) {
    try {
      const client = this.createClient(args);
      const { bundle_selection_id, api_key, ...bundleSelectionData } = args;
  ...
  async handleUpdatePlan(args) {
    try {
      const client = this.createClient(args);
      const { plan_id, api_key, ...planData } = args;
  ...
  async handleCreateSubscriptionPlan(args) {
    try {
      const client = this.createClient(args);
      const { api_key, ...subscriptionPlanData } = args;
  ...
  async handleUpdateSubscriptionPlan(args) {
    try {
      const client = this.createClient(args);
      const { subscription_plan_id, api_key, ...subscriptionPlanData } = args;
  ...
  async handleCreateShippingRate(args) {
    try {
      const client = this.createClient(args);
      const { api_key, ...shippingRateData } = args;
  ...
  async handleUpdateShippingRate(args) {
    try {
      const client = this.createClient(args);
      const { shipping_rate_id, api_key, ...shippingRateData } = args;
  ...
  async handleBulkUpdateSubscriptions(args) {
    try {
      const client = this.createClient(args);
      const { api_key, ...subscriptionsData } = args;
      const data = await client.bulkUpdateSubscriptions(subscriptionsData);
      return this.formatResponse(data);
    } catch (error) {
      return this.handleError(error);
    }
